...
class ActivityLogin : AppCompatActivity(), View.OnClickListener {
    ...
    private fun login(user : User) {
        AppTicketChecker.loggedInUserId = user.userId
        AppTicketChecker.loggedInUserName = user.name
        AppTicketChecker.loggedInUserType = user.userType
        AppTicketChecker.loggedInUserCreatedDate = user.createdAt
        AppTicketChecker.loggedInUserSoldTicketsNo = user.soldTicketsNo
        AppTicketChecker.loggedInUserValidatedTicketsNo = user.validatedTicketsNo
        AppTicketChecker.pretendedUserType = user.userType
